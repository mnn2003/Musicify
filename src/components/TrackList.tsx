      ...
      <div className="divide-y divide-gray-800">
        {tracks.map((track, index) => (
          ...
          >
            ...
            <div className="col-span-3 sm:col-span-2 md:col-span-1 flex items-center justify-end text-gray-400">
              <button
                className="mr-2 opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity text-gray-400 hover:text-white"
                onClick={(e) => {
                  e.stopPropagation()
                  handleLikeClick(track, e)
                }}
              >
                <Heart
                  size={16}
